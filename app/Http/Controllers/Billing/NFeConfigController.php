...
class NFeConfigController extends Controller
{
    ...
    public function update(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'nfe.environment' => 'required|in:1,2',
            'nfe.company_name' => 'required|string|max:255',
            'nfe.cnpj' => 'required|string|size:14',
            'nfe.state' => 'required|string|size:2',
            'nfe.schemes' => 'required|string',
            'nfe.version' => 'required|string',
            'nfe.ibpt_token' => 'nullable|string',
            'nfe.csc' => 'nullable|string',
            'nfe.csc_id' => 'nullable|string',
            'nfe.certificate_path' => 'required|string',
            'nfe.certificate_password' => 'required|string',
            'nfe.address.street' => 'required|string|max:255',
            'nfe.address.number' => 'required|string|max:10',
            'nfe.address.district' => 'required|string|max:255',
            'nfe.address.city' => 'required|string|max:255',
            'nfe.address.zipcode' => 'required|string|size:9',
            'nfe.ie' => 'required|string|max:20',
            'nfe.crt' => 'required|in:1,2,3',
            'nfe.city_code' => 'required|string|size:7',
        ]);
