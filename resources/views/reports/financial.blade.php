        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="amount">R$ {{ number_format($batches->sum('total_amount'), 2, ',', '.') }}</td>
                </tr>
                @endforeach
                <tr class="total">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $batch->health_plan_name }}</td>
                <td class="status-{{ strtolower($batch->status) }}">{{ $batch->status }}</td>
                <td>{{ number_format($batch->total_items, 0, ',', '.') }}</td>
                <td class="amount">R$ {{ number_format($batch->total_amount, 2, ',', '.') }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
